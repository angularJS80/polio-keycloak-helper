...
export const validateFastAuthConfig = (config) => {
...
// 엔드포인트 설정 유효성 검사
export const validateEndpoint = (endpointType) => {
...
// API 요청 옵션 유효성 검사
export const validateApiRequestOptions = (options) => {
...
// 토큰 유효성 검사 (통합)
export const validateToken = (userFriendly = true) => {
    if (!hasAccessToken()) {
        return {
            isValid: false,
